...
import '../student/class/class.dart';
import '../student/events/events.dart';
...
class _NavegacionState extends State<Navegacion> {
  ...
  final List<Widget> _pages = [
    ...
    const MyClassesPage(), // Tu pantalla de mis clases
    const EventsPage(), // Tu pantalla de eventos
      ...
      bottomNavigationBar: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: const Color(
              0xFF1B1B2F,
            ), // Fondo oscuro del contenedor flotante
            ...
            child: NavigationBarTheme(
              data: NavigationBarThemeData(
                ...
                indicatorColor: const Color(
                  0xFFC000FF,
                ), // Color morado de la cápsula activa
